...
<div class="card">
    ...
    <form class="form" method="post">
        ...
        <div>
            ...
            <input class="input" id="phone" name="phone" required placeholder="+63 9xx xxx xxxx">
        </div>
            ...
            <tr>
                ...
                <td>
                    <form method="post" style="display: flex; gap: 8px;">
                        ...
                        <input class="input" type="text" name="name" value="<?php echo e($member['name']); ?>" required>
                        <input class="input" type="text" name="phone" value="<?php echo e($member['phone']); ?>" required>
                        <input class="input" type="email" name="email" value="<?php echo e($member['email'] ?? ''); ?>">
